...
class SiameseLSTM_v6():

    def __init__(self, lstm_hidden_size=512, name="SiameseLSTM_v6"):
    ...
    def build_lstm_part(self, verbose=False):
        ...
        lstm_1 = layers.LSTM(self.lstm_hidden_size, return_sequences=True)
        lstm_2 = layers.LSTM(self.lstm_hidden_size)
